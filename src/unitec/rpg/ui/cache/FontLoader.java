...
public class FontLoader {
     ...
     * @return La fuente ya cargada en formato simple y tamaño 12px. En caso de error se regresa a la fuente Arial 12.
     */
    public static Font loadFont(String path) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Error al cargar la fuente: " + path, "Error", JOptionPane.ERROR_MESSAGE);
        }
